      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 cs_mb_47 text-center">
          <p className="cs_section_subtitle cs_fs-18 cs_semibold cs_accent_color cs_center cs_mb_20 wow fadeInDown">
            <span className="cs_shape_left"></span>Regarder la vidéo<span className="cs_shape_right"></span>
          </p>
          <h2 className="cs_fs_32 mb-0 wow fadeInUp">
            Nous aidons nos partenaires à donner vie à leurs projets
            <br/> et à obtenir des résultats mesurables.
          </h2>
        </div>
        <div
