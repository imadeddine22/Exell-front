      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 text-center">
          <p className="cs_section_subtitle cs_fs-18 cs_semibold cs_accent_color cs_center cs_mb_20 wow fadeInDown">
            <span className="cs_shape_left"></span>Notre processus<span className="cs_shape_right"></span>
          </p>
          <h2 className="cs_fs_48 cs_mb_21 wow fadeInUp">Notre démarche de solutions</h2>
          <p className="cs_section_heading_text mb-0 wow fadeInUp" data-wow-delay="200ms">Experience Excellence Techtro Your Leading Digital Solutions Provider. We are a leading digital agency.
</p>
        </div>
        <div className="cs_height_60 cs_height_lg_50"></div>
        <div className="cs_process_content">
          <div className="cs_heading_box cs_radius_20">
            <div className="cs_heading_box_inner cs_center cs_blue_bg cs_bold cs_white_color cs_radius_10 text-center text-uppercase">EXCELLENCIAS APPROCHE</div>
          </div>
          <div className="cs_steps_boxes_wrapper position-relative">
            <div className="cs_stepbox_wrapper position-relative wow fadeInUp">
              ...
              <span className="cs_fs_14 cs_medium">Étape</span>
              </span>
              <img src="/assets/img/step_index_1.svg" alt="Elipse shape" />
              </span>
            ...
            <div className="cs_stepbox_wrapper cs_box_2 position-relative">
              ...
              <img src="/assets/img/step_index_2.svg" alt="Elipse shape" />
              </span>
              <div className="cs_stepbox_inner cs_center cs_fs_22 cs_medium cs_heading_color cs_radius_10 text-center">Élaboration de la stratégie</div>
            </div>
            <div className="cs_stepbox_wrapper cs_box_3 position-relative">
              ...
              <img src="/assets/img/step_index_3.svg" alt="Elipse shape" />
              </span>
              <div className="cs_stepbox_inner cs_center cs_fs_22 cs_medium cs_heading_color cs_radius_10 text-center">Conception & Développement</div>
            </div>
            <div className="cs_stepbox_wrapper cs_box_4 position-relative wow fadeInUp">
              ...
              <img src="/assets/img/step_index_4.svg" alt="Elipse shape" />
              </span>
              <div className="cs_stepbox_inner cs_center cs_fs_22 cs_medium cs_heading_color cs_radius_10 text-center">Lancement & Assurance qualité</div>
            </div>
            <div className="cs_process_shape_1 position-absolute">
              <img src="/assets/img/process_shape_1.svg" alt="Line shape" />
            </div>
