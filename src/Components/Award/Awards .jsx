      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1">
          <p className="cs_section_subtitle cs_fs-18 cs_semibold cs_accent_color cs_mb_20 wow fadeInDown">
            Prix & Distinctions<span className="cs_shape_right"></span>
          </p>
          <h2 className="cs_fs_48 mb-0 wow fadeInUp">Découvrez nos prix & <br/> réalisations</h2>
        </div>
        <div className="cs_height_60 cs_height_lg_50"></div>
        <div className="cs_iconbox_wrapper_2 position-relative z-1">
          <div className="cs_hover_active">
            <div className="cs_iconbox cs_style_2">
              <div className="cs_image_layer cs_style_1">
                <div className="cs_image_layer_in cs_radius_20">
                  <img src="/assets/img/award_1.jpg" alt="Trophée de communication santé" />
                </div>
              </div>
              <Link to="/service/service-details" aria-label="Voir le détail du prix" className="cs_iconbox_icon cs_center cs_radius_50">
              ...
              <div className="cs_iconbox_content">
                <p className="cs_medium cs_mb_15">26 mars 2024</p>
                <h2 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0">
                  <Link to="/service/service-details" aria-label="Voir le détail du prix">
                    Prix de l’innovation en communication santé
                  </Link>
                </h2>
              </div>
            </div>
          ...
          <div className="cs_hover_active active">
            <div className="cs_iconbox cs_style_2">
              <div className="cs_image_layer cs_style_1">
                <div className="cs_image_layer_in cs_radius_20">
                  <img src="/assets/img/award_1.jpg" alt="Distinction audiovisuelle" />
                </div>
              </div>
              <Link to="/service/service-details" aria-label="Voir le détail du prix" className="cs_iconbox_icon cs_center cs_radius_50">
                <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="cs_iconbox_content">
                <p className="cs_medium cs_mb_15">12 juin 2024</p>
                <h2 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0">
                  <Link to="/service/service-details" aria-label="Voir le détail du prix">
                    Distinction en production audiovisuelle santé
                  </Link>
                </h2>
              </div>
            </div>
          ...
          <div className="cs_hover_active">
            <div className="cs_iconbox cs_style_2">
              <div className="cs_image_layer cs_style_1">
                <div className="cs_image_layer_in cs_radius_20">
                  <img src="/assets/img/award_1.jpg" alt="Reconnaissance pour campagnes en officine" />
                </div>
              </div>
              <Link to="/service/service-details" aria-label="Voir le détail du prix" className="cs_iconbox_icon cs_center cs_radius_50">
                <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="cs_iconbox_content">
                <p className="cs_medium cs_mb_15">5 novembre 2024</p>
                <h2 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0">
                  <Link to="/service/service-details" aria-label="Voir le détail du prix">
                    Reconnaissance pour nos campagnes en officine
                  </Link>
                </h2>
              </div>
            </div>
        ...
        <div className="cs_award_shape_1 position-absolute">
          <img src="/assets/img/spiral_1.svg" alt="Forme décorative" />
        </div>
        <div className="cs_award_shape_2 position-absolute">
          <img src="/assets/img/award_shape_1.svg" alt="Forme décorative" />
        </div>
      </div>
      <div className="cs_height_120 cs_height_lg_80"></div>
    </section>
