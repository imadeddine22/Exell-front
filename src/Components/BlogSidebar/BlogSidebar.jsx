  ...
  const chooseContent = [
    {
      ...
      title: "Lancement d’une campagne 360° pour un laboratoire",
      content:
        "Retour d’expérience : stratégie, ciblage, création et exécution terrain. Comment aligner objectifs médicaux et business pour générer des résultats mesurables."
    },
    {
      img: '/assets/img/post_10.jpg',
      title: "5 leviers SEO pour les marques santé",
      content:
        "Architecture de contenu, balisage, EEAT, performance et analytics : notre méthodologie pour gagner en visibilité tout en respectant la conformité."
    },
    {
      img: '/assets/img/post_11.jpg',
      title: "Habillage d’officine : bonnes pratiques",
      content:
        "De la création aux supports in-store : parcours patient, messages pédagogiques, et coordination des animations pour renforcer la confiance."
    },
  ];
            ...
            <div className="cs_sidebar cs_style_1 cs_type_1">
              ...
              <div className="cs_sidebar_widget cs_gray_bg_1 cs_radius_10 wow fadeInDown">
                ...
                <ul className="cs_service_category_list cs_medium cs_mp_0">
                  <li><a href="#"><span>Branding & Identité</span><span> (7)</span></a></li>
                  <li><a href="#"><span>Marketing digital</span><span> (4)</span></a></li>
                  <li><a href="#"><span>SEO & Analytics</span><span> (5)</span></a></li>
                  <li><a href="#"><span>Production audiovisuelle</span><span> (3)</span></a></li>
                  <li><a href="#"><span>Activations en officine</span><span> (6)</span></a></li>
                </ul>
              </div>
              ...
              <div className="cs_sidebar_widget cs_gray_bg_1 cs_radius_10 wow fadeInDown">
                ...
                <div className="cs_recent_post_wrapper">
                  <div className="cs_recent_post">
                    <a className="cs_recent_post_thumb cs_radius_10" href="#" aria-label="Lire l’article">
                      <img src="/assets/img/latest_post_1.jpg" alt="Article récent" />
                    </a>
                    <div className="cs_recent_post_right">
                      ...
                      <h3 className="cs_fs_16 cs_bold mb-0">
                        <a href="#" aria-label="Lire l’article">Campagnes 360° : méthode & résultats</a>
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="cs_recent_post">
                    <a className="cs_recent_post_thumb cs_radius_10" href="#" aria-label="Lire l’article">
                      <img src="/assets/img/latest_post_2.jpg" alt="Article récent" />
                    </a>
                    <div className="cs_recent_post_right">
                      <div className="cs_post_meta cs_fs_14 cs_blue_color cs_mb_9">
                      ...
                      <h3 className="cs_fs_16 cs_bold mb-0">
                        <a href="#" aria-label="Lire l’article">SEO santé : les points de vigilance</a>
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="cs_recent_post">
                    <a className="cs_recent_post_thumb cs_radius_10" href="#" aria-label="Lire l’article">
                      <img src="/assets/img/latest_post_3.jpg" alt="Article récent" />
                    </a>
                    <div className="cs_recent_post_right">
                      <div className="cs_post_meta cs_fs_14 cs_blue_color cs_mb_9">
                      ...
                      <h3 className="cs_fs_16 cs_bold mb-0">
                        <a href="#" aria-label="Lire l’article">Habillage d’officine : guide pratique</a>
                      </h3>
                    </div>
                  </div>
                </div>
              ...
              <div className="cs_sidebar_widget cs_gray_bg_1 cs_radius_10 wow fadeInDown">
                <div className="cs_sidebar_tags">
                  ...
                  <div className="cs_tags_links cs_fs_14 cs_heading_color">
                    ...
                    <a href="#" className="cs_tag_link cs_white_bg cs_radius_5">Cosmétique</a>
                    <a href="#" className="cs_tag_link cs_white_bg cs_radius_5">Branding</a>
                    <a href="#" className="cs_tag_link cs_white_bg cs_radius_5">Campagne 360°</a>
              ...
              {chooseContent.map((item, i) => (
                <div key={i} className="col-12">
                  <div className="cs_post cs_style_1 cs_type_2 cs_radius_10 wow fadeInRight">
                    <Link to="/blog/blog-details" aria-label="Lire l’article" className="cs_post_thumbnail cs_radius_8 cs_mb_26 position-relative">
                      <img src={item.img} alt="Miniature de l’article" />
                      <span className="cs_posted_by cs_blue_bg cs_white_color cs_radius_5 text-center position-absolute">
                        ...
                        <span className="cs_fs_14">Juil.</span>
                      </span>
                    </Link>
                    ...
                    <h3 className="cs_post_title cs_fs_24 cs_mb_14">
                      <Link to="/blog/blog-details" aria-label="Lire l’article">{item.title}</Link>
                    </h3>
                    <p className="cs_post_subtitle cs_mb_23">{item.content}</p>
                    <Link to="/blog/blog-details" aria-label="Lire l’article" className="cs_post_btn cs_fs_14 cs_semibold cs_radius_5">
