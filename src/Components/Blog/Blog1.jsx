...
const Blog1 = () => {
  ...
  const chooseContent = [
  {
    ...
    title: 'Lancement de la campagne Bronchopan',
    content: 'Retour sur notre habillage national des pharmacies et les résultats obtenus sur le marché algérien.'
  },
  {
    img: '/assets/img/post_2.jpg',
    title: 'Excellencias Academy : Nouvelle session de formation',
    content: 'Nos ateliers interactifs offrent aux professionnels de santé des outils pratiques et innovants.'
  },
  {
    img: '/assets/img/post_3.jpg',
    title: 'Tourisme médical avec HealthGate',
    content: 'Comment nous accompagnons les patients vers des soins de qualité en Turquie, Tunisie et Jordanie.'
  },
  {
    img: '/assets/img/post_4.jpg',
    title: 'Excellencias Studio : Production audiovisuelle',
    content: 'De la vidéo institutionnelle aux podcasts, découvrez nos dernières réalisations en communication visuelle.'
  }
];
      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 cs_type_1">
          <div className="cs_section_heading_left">
            ...
            Nos actualités<span className="cs_shape_right"></span>
            </p>
           <h2 className="cs_fs_48 mb-0 wow fadeInUp">
  Suivez les dernières actualités <br/> d’Excellencias Corporate
</h2>
          ...
          {chooseContent.map((item, i) => (
            <div key={i} className="cs_slide">
              <article className="cs_post cs_style_1 position-relative">
                <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_thumbnail cs_radius_15">
                <img src={item.img} alt="Post thumbnail" />
                <span className="cs_posted_by cs_radius_4 text-center position-absolute">
                <span className="cs_date cs_orange_bg cs_white_color">19</span>
                <span className="cs_month cs_white_bg cs_heading_color text-uppercase">Dec</span>
                </span>
                </Link>
                <div className="cs_post_content cs_white_bg cs_radius_15">
                  ...
                  <h3 className="cs_post_title cs_fs_20 cs_semibold cs_mb_7"><Link to="/blog/blog-details" aria-label="Click to read post">{item.title}</Link></h3>
                  <p className="cs_post_subtitle">{item.content}</p>
                  <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_btn">
                    <span>Read More</span>
                    <span className="cs_accent_color">
