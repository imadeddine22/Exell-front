    ...
    const chooseContent = [
        {
          ...
          title:'Campagne Bronchopan',
          content:'Retour sur l’habillage national des pharmacies et son impact sur le marché.'
        },
        {
          img:'/assets/img/post_4.jpg',
          title:'Excellencias Academy',
          content:'Une nouvelle session de formation pour les professionnels de santé en Algérie.'
        },
        {
          img:'/assets/img/post_5.jpg',
          title:'Tourisme médical HealthGate',
          content:'Accompagnement des patients vers des soins de qualité en Turquie et Tunisie.'
        },
    ]; 
      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 text-center">
          <p className="cs_section_subtitle cs_fs-18 cs_semibold cs_blue_color cs_center cs_mb_20 wow fadeInDown">
            <span className="cs_shape_left"></span>Actualités<span className="cs_shape_right"></span>
          </p>
          <h2 className="cs_fs_48 mb-0 wow fadeInUp">Découvrez nos dernières nouvelles et articles</h2>
        </div>
        ...
        {chooseContent.map((item, i) => (
          <div key={i} className="col-lg-4 wow fadeInUp">
            <article className="cs_post cs_style_2 position-relative">
              <Link to="/blog/blog-details" aria-label="Cliquez pour lire l’article" className="cs_post_thumbnail cs_radius_15 position-relative">
              ...
              <div className="cs_post_content cs_gray_bg_1">
                ...
                <h3 className="cs_post_title cs_fs_20 cs_mb_18">
                  <Link to="/blog/blog-details" aria-label="Cliquez pour lire l’article">{item.content}</Link>
                </h3>
                <Link to="/blog/blog-details" aria-label="Cliquez pour lire l’article" className="cs_post_btn cs_fs_18 cs_semibold text-uppercase">
                  <span>Lire plus</span>
