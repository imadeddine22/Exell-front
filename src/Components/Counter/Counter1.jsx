        ...
        <div className="row">
          <div className="col-lg-3 col-sm-6">
            <div className="cs_counter_wrapper cs_bg_gradient">
              ...
              <p className="cs_counter_title cs_fs_18 mb-0">années d’expérience</p>
            </div>
          </div>
          <div className="col-lg-3 col-sm-6">
            <div className="cs_counter_wrapper">
              ...
              <p className="cs_counter_title cs_fs_18 mb-0">Clients satisfaits</p>
            </div>
          </div>
          <div className="col-lg-3 col-sm-6">
            <div className="cs_counter_wrapper cs_bg_gradient">
              ...
              <p className="cs_counter_title cs_fs_18 mb-0">Projets livrés</p>
            </div>
          </div>
          <div className="col-lg-3 col-sm-6">
            <div className="cs_counter_wrapper">
              ...
              <p className="cs_counter_title cs_fs_18 mb-0">Employés</p>
            </div>
          </div>
        </div>
      </div>
